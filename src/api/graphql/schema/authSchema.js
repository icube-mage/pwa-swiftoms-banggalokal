...
const customerSchema = makeExecutableSchema({
    typeDefs: gql`
        ...
        type Mutation {
            internalGenerateCustomerToken(email: String!, password: String!): Token
            internalGenerateSocialLoginToken(email: String!, social_token: String!, otp_code: String): Token
