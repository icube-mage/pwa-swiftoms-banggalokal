...
import gqlService from '@modules/configurationpybmeta/services/graphql';
...
const ContentWrapper = (props) => {
    ...
    const dataConfig = [...data.getMetaAdsConfiguration];
...
const Core = (props) => {
    ...
    const pageConfig = {
        title: t('configuration:PYB_Configuration_Meta'),
    };
    const { loading, data, refetch } = gqlService.getMetaAdsConfiguration();
