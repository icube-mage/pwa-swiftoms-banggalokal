...
import InputText from '@modules/configurationpybmeta/pages/default/components/Input/inputText';
import InputSelect from '@modules/configurationpybmeta/pages/default/components/Input/inputSelect';
import useStyles from '@modules/configurationpybmeta/pages/default/components/style';
...
const PybConfigContent = (props) => {
    ...
    return (
        <>
            <h2 className={classes.titleTop}>{t('configuration:PYB_Configuration_Meta')}</h2>
