...
import InputText from '@modules/configurationpybgoogle/pages/default/components/Input/inputText';
import InputSelect from '@modules/configurationpybgoogle/pages/default/components/Input/inputSelect';
import useStyles from '@modules/configurationpybgoogle/pages/default/components/style';

const PybConfigContent = (props) => {
    ...
    return (
        <>
            <h2 className={classes.titleTop}>{t('configuration:PYB_Configuration_Google')}</h2>
...
export default PybConfigContent;
