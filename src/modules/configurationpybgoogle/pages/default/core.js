...
import gqlService from '@modules/configurationpybgoogle/services/graphql';
...
const ContentWrapper = (props) => {
    ...
    const dataConfig = [...data.getGoogleAdsConfiguration];
...
const Core = (props) => {
    ...
    const pageConfig = {
        title: t('configuration:PYB_Configuration_Google'),
    };
    const { loading, data, refetch } = gqlService.getGoogleAdsConfiguration();
