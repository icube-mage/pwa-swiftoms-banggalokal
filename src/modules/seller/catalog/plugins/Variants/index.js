                    ...
                    <Fragment key={idx}>
                        <div className={classes.formFieldsGrid}>
                            ...
                            <Grid container spacing={3}>
                                <Grid item xs={10} sm={variant?.frontend_label ? 2 : 11} name="variants">
                                    <Button
                                ...
                                <Hidden smUp>
                                    <Grid item xs={1} sm={1}>
                                        <div className={clsx('btn-delete', classes.centering)}>
                                            <img
                                                ...
                                                <Autocomplete
                                                    ...
                                                    filterOptions={(options, params) => {
                                                        ...
                                                        if (params.inputValue !== ''
                                                            ...
                                                            && !options?.find((v) => v.label === params.inputValue)) {
                                                            filtered.push({
                                                                inputValue: params.inputValue,
                                                                label: `${t('sellercatalog:Add')} "${params.inputValue}"`,
                                                            });
                                                        }
                                                        return filtered;
                                                    }}
                                                        ...
                                                        <TextField
                                                            ...
                                                            onKeyDown={(e) => {
                                                                if (e.keyCode === 13 && e.target.value && (variant.vendor_id || variant.is_new)
                                                                    ...
                                                                    && !variant.attribute_options?.find((v) => v.label === e.target.value)) {
