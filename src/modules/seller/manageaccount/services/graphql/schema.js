...
export const connectAccountWithSocialMedia = gql`
    mutation connectAccountWithSocialMedia($email: String!, $social_token: String!){
        connectAccountWithSocialMedia(email: $email, social_token: $social_token)
    }
`;
