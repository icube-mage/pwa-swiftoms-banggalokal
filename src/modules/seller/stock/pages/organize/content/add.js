...
import DropFile from '@sellermodules/stock/plugins/Dropfile';
                        ...
                        && (
                            <div>
                                <div className={clsx(classes.centering, 'success')}>
                                    {t('sellerstock:Upload_product_has_been_completed')}
                                </div>
                        ...
                        && (
                            <div>
                                <div className={clsx(classes.centering, 'error', 'noflex')}>
                                    <span>{t('sellerstock:Something_wrong_while_uploading_product')}</span>
                                    <br />
