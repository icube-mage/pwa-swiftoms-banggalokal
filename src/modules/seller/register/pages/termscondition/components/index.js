...
import useStyles from '@sellermodules/register/pages/termscondition/components/style';

const termsconditionContent = (props) => {
                ...
                <div className={classes.content}>
                    <div className={classes.titleContainer}>
                        <div className={classes.textTitle}>
                            {t('registerseller:Terms_and_Condition')}
                        </div>
                    </div>
