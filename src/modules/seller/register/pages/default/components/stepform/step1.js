...
import { filterPhone } from '@modules/login/helpers/otp';
...
const RegisterSeller = (props) => {
    ...
    const {
        ...
        getSocialSession, phone, setPhone, isOtpVerify,
    } = props;
        ...
        <>
            ...
            <div className={clsx('col-xs-12 col-sm-12', classes.formField)}>
                ...
                <TextField
                    id="email"
                    name="email"
                    value={getSocialSession?.email ? getSocialSession?.email : formik.values.email}
                    onChange={!getSocialSession?.email && formik.handleChange}
                    className={classes.textInput}
                    error={!!(formik.touched.email && formik.errors.email)}
                    helperText={(formik.touched.email && formik.errors.email) || ''}
                    onBlur={formik.handleBlur}
                    disabled={getSocialSession?.email ? true : false}
                />
            </div>

            {!getSocialSession?.email && (
                <>
                    <div className={clsx('col-xs-12 col-sm-12', classes.formField)}>
            ...
            <div className={clsx('col-xs-12 col-sm-12', classes.formField)} style={{ position: 'relative' }}>
                ...
                <PhoneInput
                    ...
                    onChange={(e, c) => {
                        if (isOtpVerify === false) {
                            ...
                            setPhone(filterPhone(e));
                            setDialCode(c.dialCode);
                        }
                    }}
                    error={isOtpVerify === false && !!(formik.touched.phone_number && formik.errors.phone_number)}
                    helperText={(isOtpVerify === false && formik.touched.phone_number && formik.errors.phone_number) || ''}
                    ...
                    disabled={isOtpVerify === true}
                />
                {isOtpVerify === true && (
                    <span className={classes.verifiedOtp}>
                        ...
                        <FormControlLabel
                            ...
                            label={(
                                <span>
                                    ...
                                    {' '}
                                    <a className={classes.termsCondition} href="/seller-registration-tnc" target="_blank">
