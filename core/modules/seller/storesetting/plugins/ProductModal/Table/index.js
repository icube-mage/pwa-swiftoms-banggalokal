...
import TablePaginationActions from '@sellermodules/storesetting/plugins/ProductModal/Table/components/TablePaginationActions';
import Header from '@sellermodules/storesetting/plugins/ProductModal/Table/components/Header';
import { getComponentOrString, useDebounce, isEmpty } from '@sellermodules/storesetting/plugins/ProductModal/Table/helpers';
        ...
        return (
            <TableBody>
                {rows.map((row, rowIndex) => (
                    <TableRow key={rowIndex} className={classNames(classes.tableRow, rowIndex % 2 && 'gray', 'grid-item')}>
