...
import useStyles from '@sellermodules/storesetting/pages/displaywindow/create/components/style';
        ...
        <div>
            <div className={classes.headerContainer}>
                <div className="left">
                    ...
                    <h2 className={classes.title}>{t('storesetting:Add_Display_Window')}</h2>
                </div>
                <Button
                    id="button-save"
