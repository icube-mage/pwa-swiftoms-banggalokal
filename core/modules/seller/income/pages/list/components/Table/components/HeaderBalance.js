...
const TabsHeader = (props) => {
    const {
        searchPlaceholder = '', filters = [], setFilters, handleExport = () => { },
        search, setSearch, t,
    } = props;
        ...
        <>
            <div className={classes.tableToolbar}>
                ...
                <div className={classes.expandContainer}>
                    <Collapse in={search || !filters.every((field) => isEmpty(field.value))}>
            ...
            <DateModal
                ...
                title={t('sellercatalog:Export_Balance_History')}
                disableFuture
                minDate={30}
                maxDate={30}
            />
