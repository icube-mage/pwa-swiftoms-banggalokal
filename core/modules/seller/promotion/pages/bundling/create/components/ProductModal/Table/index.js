...
import TablePaginationActions from '@sellermodules/promotion/pages/bundling/create/components/ProductModal/Table/components/TablePaginationActions';
import Header from '@sellermodules/promotion/pages/bundling/create/components/ProductModal/Table/components/Header';
import Variants from '@sellermodules/promotion/pages/bundling/create/components/ProductModal/Table/components/Variants';
import { getComponentOrString, useDebounce, isEmpty } from '@sellermodules/promotion/pages/bundling/create/components/ProductModal/Table/helpers';
import useStyles from '@sellermodules/promotion/pages/bundling/create/components/ProductModal/Table/style';
                    ...
                    <Fragment key={rowIndex}>
                        <TableRow className={classNames(classes.tableRow, rowIndex % 2 && 'gray', 'grid-item')}>
                            <TableCell padding="checkbox" className={clsx(classes.alignTop, !!row.variants?.length && 'noborder')}>
                                {checkedRows.length === 3 && !checkedRows
                                    .find((checkedRow) => checkedRow[primaryKey] === row[primaryKey])
                                    ? null : (
                                        <Checkbox
                                            ...
                                            disabled={!checkedRows
                                                .find((checkedRow) => checkedRow[primaryKey] === row[primaryKey]) && checkedRows.length === 3}
                                        />
                                    )}
                            </TableCell>
                            {columns.map((column, columnIndex) => (
