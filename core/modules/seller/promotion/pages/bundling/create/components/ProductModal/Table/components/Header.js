...
import { useDebounce, isEmpty } from '@sellermodules/promotion/pages/bundling/create/components/ProductModal/Table/helpers';
...
const TabsHeader = (props) => {
    const {
        ...
        search, setSearch, t, categories, setSorts,
    } = props;
                            ...
                            >
                                {categories.map((cat, i) => (
                                    <MenuItem key={i} className={classes.menuItem}>
                                        <Checkbox
                                            label={cat.name}
                                            checked={filterCat.includes(String(cat.id))}
                                            setChecked={(e) => handleChecked(e.target.checked, cat)}
