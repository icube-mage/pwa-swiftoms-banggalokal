...
import useStyles from '@sellermodules/promotion/pages/coupon/edit/components/style';
        ...
        <div className={classes.container}>
            ...
            <Paper className={classes.paper}>
                ...
                <FormInput
                    ...
                    placeholder={t('sellerpromotion:Name_of_the_Rule._Exp:_Free_Shipping_October')}
                    required
                    {...props}
                />
                <FormInput
                ...
                <FormInput
                    ...
                    placeholder={t('sellerpromotion:Coupon_Usage_per_Customer')}
                    type="integer"
                    {...props}
                />
            </Paper>
