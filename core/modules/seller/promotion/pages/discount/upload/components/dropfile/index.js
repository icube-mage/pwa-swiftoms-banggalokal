...
import useStyles from '@sellermodules/promotion/pages/discount/upload/components/dropfile/style';
                ...
                <Grid container spacing={3}>
                    <Grid item xs="auto">
                        <Button className={classes.btnFile} buttonType="outlined" onClick={open}>
                            {files.length === 0 ? t('sellerpromotion:Select_File') : t('sellerpromotion:Change_File')}
                        </Button>
                    </Grid>
                    {files.length
                        ? (
