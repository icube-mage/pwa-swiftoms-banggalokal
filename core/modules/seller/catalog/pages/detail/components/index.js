...
import useStyles from '@sellermodules/catalog/pages/detail/components/style';

const CatalogOrganizeContent = (props) => {
    const {
        t, handleDropFile, formik, shippingOptions, isDuplicate, shipConfig, dataEtalase,
    } = props;
    ...
    return (
        <div className={classes.container}>
            ...
            <Paper className={classes.paper}>
                ...
                />
                <FormInput
                    name={isDuplicate ? 'sku' : 'vendor_sku'}
            ...
            <Paper className={classes.paper}>
                ...
                {formik.values.is_variant
                    && <VariantsContent isEdit={!isDuplicate} {...props} />}
            </Paper>
            <Paper className={classes.paper}>
                        ...
                        helper={shippingOptions.length ? null
                            : (
                                <>
                                    ...
                                    {' '}
                                    <a className={classes.helperLink} aria-hidden="true" href="/seller/storesetting?setting=shipping" target="_blank">
