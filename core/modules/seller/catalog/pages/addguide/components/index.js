...
import useStyles from '@sellermodules/catalog/pages/addguide/components/style';
    ...
    return (
        <>
            <div className={classes.headerContainer}>
                <div className="left">
                    <IconButton aria-label="back" onClick={() => router.push('/seller/catalog/organize/add')}>
                        <ArrowBackOutlinedIcon />
                    </IconButton>
                    <h2 className={classes.title}>{t('sellercatalog:Add_at_Once')}</h2>
                </div>
            </div>
            <Paper>
                <div className={classes.contentWithoutBorder}>
                    <p>
                        {t('sellercatalog:To_Add_at_Once_Products_please_follow_these_steps')}
                    </p>
                    <ol>
                        <li>
                            <p style={{ marginTop: 0 }}>
                                {t('sellercatalog:Prepare_the_Products_in_a_CSV_format_You_can_use_the_template_containing_the_required_data_that_can_be_downloaded_from')}
                                {' '}
                                <b>{t('sellercatalog:Catalog_>_Set_At_Once_>_Add_at_Once_>_Download__fill_in_CSV_files_>_Download_Template')}</b>
                            </p>
                        </li>
                        <li>
                            <p>
                                {t('sellercatalog:Open_the_template_using_any_supported_application_The_first_row_is_the_fieldcolumn_name_while_below_it_is_the_products_data')}
                                <br />
                                <b>
                            ...
                            <div className={classes.imgDiv}>
                                <img className={classes.imgImage} src="/assets/img/tutorial_content/seller_add_catalog/tutorial01.png" alt="excel-example" />
                            </div>
                            <p style={{ fontSize: 11 }}>
                                *
                            ...
                            <ul className={classes.ulChild}>
                                <li>
                                    <p>
                                        ...
                                        {' '}
                                        {t('sellercatalog:Product’s_SKU_Stock_Keeping_Unit_SKU_must_be_unique_different')}
                                    </p>
                                </li>
                                <li>
                                    <p>
                                ...
                                <li>
                                    <p>
                                        ...
                                        {' '}
                                        <b>{t('sellercatalog:Catalog_>_Set_At_Once_>_Add_at_Once_>_Download_list_of_category_list_of_display_window__list_of_shipping_method_>_Category')}</b>
                                        {' '}
                                ...
                                <li>
                                    <p>
                                        ...
                                        {' '}
                                        <b>{t('sellercatalog:Catalog_>_Set_At_Once_>_Add_at_Once_>_Download_list_of_category_list_of_display_window__list_of_shipping_method_>_Display_Window')}</b>
                                    </p>
                                </li>
                                <li>
                                    <p>
                                        ...
                                        {' '}
                                        <b>{t('sellercatalog:Catalog_>_Set_At_Once_>_Add_at_Once_>_Download_list_of_category_list_of_display_window__list_of_shipping_method_>_Shipping_Method')}</b>
                                        {' '}
                        ...
                        <li>
                            <p>
                                {t('sellercatalog:Select_the_CSV_file_you_edited_earlier_by_clicking')}
                                {' '}
                            ...
                            <div className={classes.imgDiv}>
                                <img className={classes.imgImage} src="/assets/img/tutorial_content/seller_add_catalog/tutorial02.png" alt="excel-example" />
                            </div>
                        </li>
                        <li>
                            <p>
                            ...
                            <div className={classes.imgDiv}>
                                <img className={classes.imgImage} src="/assets/img/tutorial_content/seller_add_catalog/tutorial03.png" alt="excel-example" />
                            </div>
                            <p>
                            ...
                            <div className={classes.imgDiv}>
                                <img className={classes.imgImage} src="/assets/img/tutorial_content/seller_add_catalog/tutorial04.png" alt="excel-example" />
                            </div>
                            <p>
                            ...
                            <div className={classes.imgDiv}>
                                <img className={classes.imgImage} src="/assets/img/tutorial_content/seller_add_catalog/tutorial05.png" alt="excel-example" />
                            </div>
                            <p>
                    ...
                    <ol>
                        <li>
                            ...
                            <div className={classes.imgDiv}>
                                <img className={classes.imgImage} src="/assets/img/tutorial_content/seller_add_catalog/tutorial06.png" alt="excel-example" />
                            </div>
                        </li>
                        <li>
                            <p>
                        ...
                        <li>
                            ...
                            <div className={classes.imgDiv}>
                                <img className={classes.imgImage} src="/assets/img/tutorial_content/seller_add_catalog/tutorial07.png" alt="excel-example" />
                            </div>
                        </li>
                    </ol>
                </div>
