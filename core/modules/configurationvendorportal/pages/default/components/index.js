...
import useStyles from '@modules/configurationvendorportal/pages/default/components/style';
...
import InputText from '@modules/configurationvendorportal/pages/default/components/inputText';
import InputSelect from '@modules/configurationvendorportal/pages/default/components/inputSelect';
import InputTable from '@modules/configurationvendorportal/pages/default/components/inputTable';
import InputMultiSelect from '@modules/configurationvendorportal/pages/default/components/inputMultiSelect';

const ConfigVendorPortalContent = (props) => {
    const { formik, dataVendorPortal, t } = props;
    ...
    return (
        <>
            <h2 className={classes.titleTop}>{t('vendorconfiguration:Vendor_Configuration')}</h2>
            <Paper className={classes.container}>
                <div className={classes.content}>
                    {dataVendorPortal?.map((parent, index) => (
                        <Accordion
...
export default ConfigVendorPortalContent;
