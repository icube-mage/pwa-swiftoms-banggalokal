...
import useStyles from '@modules/configurationintegrations/pages/create/components/integrationinfocontent/style';
        ...
        <>
            ...
            <div className={classes.content}>
                ...
                <div className={classes.warning}>
                    <img src="/assets/img/yellow_warning.svg" alt="yellow-warning" />
                    {t('configurationintegrations:Please_activate_first_in_order_to_generate_Integration_Token')}
                </div>
            </div>
        </>
    );
