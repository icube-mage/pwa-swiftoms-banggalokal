...
import IntegrationInfoContent from '@modules/configurationintegrations/pages/edit/components/integrationinfocontent';
import APIsContent from '@modules/configurationintegrations/pages/edit/components/apiscontent';
            ...
            <div className={classes.topSection}>
                <div>
                    ...
                    <h2 className={classes.titleTop}>
                        {t('configurationintegrations:Edit_Integration')}
                    </h2>
                </div>
