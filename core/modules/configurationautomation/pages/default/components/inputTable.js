                        ...
                        <table className={classes.table}>
                            <thead>
                                <tr>
                                    ...
                                    {is_delete
                                        && (
                                            <th style={{ width: 'auto' }}>{t('configurationautomation:Action')}</th>
                                        )}
                                </tr>
                            </thead>
                            <tbody>
                                                ...
                                                && (
                                                    <td>
                                                        <img
                                                            ...
                                                            alt={t('configurationautomation:Delete')}
                                                            style={{
                                                                height: 15,
                                                                width: 'auto',
                        ...
                        canRestore && (
                            <div className="hidden-mobile">
                                <FormControlLabel
                                    ...
                                    label={t('configurationautomation:Use_system_value')}
                                />
                            </div>
                        )
                    }
