...
import useStyles from '@modules/configurationfinance/pages/default/components/style';
...
import InputText from '@modules/configurationfinance/pages/default/components/inputText';
import InputSelect from '@modules/configurationfinance/pages/default/components/inputSelect';

const ConfigFinanceContent = (props) => {
    const { formik, dataFinance, t } = props;
    ...
    return (
        <>
            <h2 className={classes.titleTop}>{t('financeconfiguration:Finance_Configuration')}</h2>
            <Paper className={classes.container}>
                <div className={classes.content}>
                    {dataFinance?.map((parent, index) => (
                        <Accordion
...
export default ConfigFinanceContent;
