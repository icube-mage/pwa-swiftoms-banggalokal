...
const LocationEditContent = (props) => {
    const {
        formik, customer, handleDragPosition, gmapKey, mapPosition, enableMap,
        shipperIdConfig, logistixConfig, lionParcelConfig, t, setDialCode,
    } = props;
    ...
    return (
        <>
            ...
            <h2 className={classes.titleTop}>{t('location:Edit_Location')}</h2>
