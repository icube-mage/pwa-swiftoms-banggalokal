...
import useStyles from '@modules/productattributes/pages/edit/components/style';
...
const ProductAttributesContent = (props) => {
    ...
    return (
        <>
            ...
            <h2 className={classes.titleTop}>{t('productattributes:Edit_Product_Attribute')}</h2>
